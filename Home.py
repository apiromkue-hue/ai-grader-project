...
# --- โค้ดนักสืบ: สั่งให้ระบบโชว์รายชื่อไฟล์ออกมา ---
st.write("--- 🔍 เริ่มการตรวจสอบไฟล์ ---")
if os.path.exists("pages"):
    st.success("✅ พบโฟลเดอร์ pages แล้ว!")
    files = os.listdir("pages")
    st.write("📂 รายชื่อไฟล์ทั้งหมดใน pages คือ:")
    st.code(files) # ตรงนี้จะโชว์ชื่อไฟล์จริงๆ ที่ระบบเห็น
else:
    st.error("❌ ไม่พบโฟลเดอร์ pages เลย! (โฟลเดอร์หาย)")
st.write("---------------------------------")
# -------------------------------------------
